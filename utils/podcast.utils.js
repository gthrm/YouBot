...
const createFeed = ({ title, description, feed_url }) => new Podcast({
  title,
  description,
  feed_url,
  site_url: 'https://rss.cdroma.me/',
  image_url:
      'https://cloud.cdroma.me/upload/3145d832b74f2f16f6b823fd312a5d131625916895274.png',
...
const addItemToFeed = (feed, {
  title, description, url, date, fileUrl, _id,
}) => feed.addItem({
  title, // "item title",
  guid: _id,
